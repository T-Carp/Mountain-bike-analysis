...
fluidRow( 
           ...
           column(6,p("Is this bike a good deal?   How is it priced compared to other models?   What price should I sell my bike for?") , 
                    p("Using data from pinkbike.com ads, we can explore how different bike models are priced and how asking-prices change over time.  This tool can also help you quickly spot potential deals where bikes are priced below average.  Dataset is not inclusive of every bike on pinkbike, only the most popular models."), align = "center"),
           column(3,"")),
 ...
 ggplotly(p)%>% 
  ...
  output$table <- renderDT(
       ...
       shared_data$data(withSelection = TRUE) %>% filter(selected_ | is.na(selected_)) %>% 
                  mutate(url = paste0("<a href='",url,"'",'target="_blank"',">",url,"</a>")),escape = FALSE) 
