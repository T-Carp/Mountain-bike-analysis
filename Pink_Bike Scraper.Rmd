...
### Append new data to database tables.
```{r}
creds <- read.csv("/Users/t-carpen93/Data Projects/Credentials/creds.csv")
user <- as.character(creds[,2:2])
password <- as.character(creds[,3:3])
...
dbWriteTable(cn, name = "model_price_summary", value = df_model_price, append = TRUE)
dbWriteTable(cn, name = "brand_price_summary", value = df_price, append = TRUE)
