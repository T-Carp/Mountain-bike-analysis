...
p("Use the filters on the left to explore how different mountaib bike models are priced. To see the table info for a specific point on the chart, click and drag your cursor to select multiple items in the scatter plot."),
